            ...
            <div className='w-full'>
              ...
              <div className='px-6 w-full'>
                ...
                <div className=' border border-white rounded-3xl px-4 py-2 gap-2 mb-6'>
                  <label className='text-white font-bold block' htmlFor="">Message</label><textarea className='bg-transparent px-2 md:px-4 outline-none text-black text-[16px] w-full lg:min-h-[114px] ' name="message" id=""></textarea>
                </div>
                <div>
