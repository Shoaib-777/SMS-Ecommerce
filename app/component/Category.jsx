...
const Category = async() => {
  const categoryf = await FetchCatrgory()
    ...
    <div className='border-b-2 border-gray-200 mt-2 mb-4'>
      <div className='flex justify-between'>
        ...
        <div className='mx-auto py-2 px-4 flex gap-3 lg:justify-center overflow-x-scroll scrollbar-hide mb-4'>
          ...
          <div key={i} className='w-[210px] h-[250px] border border-gray-200 shadow-lg px-2 shrink-0 '>
                <Link href={`/category/${v}`}><img src={imageUrl} alt="no category found" className='w-[200px] h-[200px] object-contain ' />
                <h4 className='font-bold text-xl mt-2 text-center mr-4'>{v}</h4></Link>
            </div>
            </>
             )
            })}
